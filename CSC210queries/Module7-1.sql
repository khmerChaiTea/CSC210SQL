...
--	First try the INSERT by stored procedure to see that it doesn't work because it is not there
...
INSERT Sales.OrderDetails (orderid, productid, unitprice, quantity, discount)
OUTPUT INSERTED.*
SELECT * FROM NewOrderDetails
